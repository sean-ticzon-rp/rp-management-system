                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <Alert className="border-[#2596be] bg-blue-50">
                        ...
                        <AlertDescription className="text-blue-800">
                            <strong>Note:</strong> All fields are optional. You
                            can provide these details later if you don't have
                            them yet.
                        </AlertDescription>
                    </Alert>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                form.setData('sss_number', e.target.value)
                            }
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                form.setData('hdmf_number', e.target.value)
                            }
