...
import {
    ...
    Briefcase,    // Make sure this is here
} from 'lucide-react';
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="bg-gray-50 hover:bg-gray-50">
                                    ...
                                    <TableHead className="font-semibold">Assigned Assets</TableHead>
                            ...
                            <TableBody>
                                {users.data.length > 0 ? (
                                    users.data.map((user, index) => (
                                        <TableRow key={user.id} className={`hover:bg-gray-50 animate-fade-in-up animation-delay-${Math.min((index + 3) * 100, 900)}`}>
                                            ...
                                            <TableCell>
                                                <div className="flex flex-wrap gap-1">
                                                    {user.roles && user.roles.length > 0 ? (
                                                        user.roles.map((role) => (
                                                            <Badge key={role.id} className="bg-purple-100 text-purple-700 border-purple-200 border">
