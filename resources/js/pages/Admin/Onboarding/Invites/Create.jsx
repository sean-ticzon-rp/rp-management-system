                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-gray-600">
                                    Invite a new hire to complete pre-onboarding
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="mx-auto max-w-3xl space-y-6">
                ...
                <Alert className="animate-fade-in border-blue-200 bg-blue-50">
                    ...
                    <AlertDescription className="text-blue-800">
                        <strong>How it works:</strong> The candidate will
                        receive an email with a unique guest link valid for 14
                        days. They can fill out their information and upload
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card className="animate-fade-in animation-delay-100">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Basic details about the new hire (optional but
                                recommended)
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Will be used in the invitation email
                                    </p>
                                </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                            ...
                                            {roles && roles.length > 0 ? (
                                                <>
                                                    ...
                                                    {roles.filter(
                                                        ...
                                                        <>
                                                            <div className="mt-2 px-2 py-1.5 text-xs font-semibold uppercase text-gray-500">
                                                                Management &
                                                                Admin Roles
                                                            </div>
                                                            {roles
                                    ...
                                    <p className="text-xs text-gray-500">
                                        ⚠️ Position is locked - candidate cannot
                                        change this
                                    </p>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        Auto-filled based on position (can be
                                        changed)
                                    </p>
                                </div>
                            </div>
                    ...
                    {/* What Happens Next */}
                    <Card className="animate-fade-in animation-delay-200 border-green-200 bg-green-50">
                        <CardHeader>
                        ...
                        <CardContent className="space-y-3 text-sm text-green-800">
                            <div className="flex items-start gap-2">
                                ...
                                <p>
                                    An email will be sent to the candidate with
                                    a unique guest link
                                </p>
                            </div>
                            <div className="flex items-start gap-2">
                                ...
                                <p>
                                    The candidate can access the onboarding
                                    portal without login (valid for 14 days)
                                </p>
                            </div>
                            <div className="flex items-start gap-2">
                                <div className="mt-0.5 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-green-200">
                                ...
                                <p>
                                    They'll fill personal information and upload
                                    required documents
                                </p>
                            </div>
                            <div className="flex items-start gap-2">
                                ...
                                <p>
                                    You'll review their submission and convert
                                    it to an employee account
                                </p>
                            </div>
                        </CardContent>
                    </Card>
