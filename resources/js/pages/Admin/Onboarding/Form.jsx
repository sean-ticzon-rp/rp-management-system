...
export default function Form({ invite, submission, requiredDocuments }) {
    ...
    const handleSavePersonalInfo = () => {
        personalForm.post(
            route('guest.onboarding.update-personal-info', invite.token),
            {
                preserveScroll: true,
    ...
    const handleSaveGovIds = () => {
        govIdForm.post(
            route('guest.onboarding.update-government-ids', invite.token),
            {
                preserveScroll: true,
    ...
    const handleSaveEmergency = () => {
        emergencyForm.post(
            route('guest.onboarding.update-emergency-contact', invite.token),
            {
                preserveScroll: true,
    ...
    const handleUploadDocument = (e) => {
        e.preventDefault();
        documentForm.post(
            route('guest.onboarding.upload-document', invite.token),
            {
                preserveScroll: true,
    ...
    const handleDeleteDocument = (documentId) => {
        if (confirm('Are you sure you want to delete this document?')) {
            router.delete(
                route('guest.onboarding.delete-document', [
                    invite.token,
                    documentId,
                ]),
                {
    ...
    const handleFinalSubmit = () => {
        router.post(
            route('guest.onboarding.submit', invite.token),
            {},
            {
                onSuccess: () => {
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 px-4 py-12">
                <div className="mx-auto max-w-4xl space-y-6">
                    ...
                    <div className="animate-fade-in text-center">
                        ...
                        {invite.position && (
                            <div className="mt-4 flex items-center justify-center gap-2">
                                <Badge className="border border-blue-200 bg-blue-100 px-4 py-1.5 text-base text-blue-700">
                                    <Briefcase className="mr-2 h-4 w-4" />
                                    {invite.position}
                                </Badge>
                                {invite.department && (
                                    <Badge className="border border-purple-200 bg-purple-100 px-4 py-1.5 text-base text-purple-700">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select
                                            value={
                                                personalForm.data.civil_status
                                            }
                                            onValueChange={(value) =>
                                                personalForm.setData(
                                                    'civil_status',
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            value={
                                                personalForm.data.address_line_1
                                            }
                                            onChange={(e) =>
                                                personalForm.setData(
                                                    'address_line_1',
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            value={
                                                personalForm.data.address_line_2
                                            }
                                            onChange={(e) =>
                                                personalForm.setData(
                                                    'address_line_2',
                                ...
                                >
                                    <Alert className="border-blue-200 bg-blue-50">
                                        ...
                                        <AlertDescription className="text-blue-800">
                                            ...
                                            are optional for now. You can
                                            provide these details later if you
                                            don't have them yet.
                                        </AlertDescription>
                                    </Alert>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            value={
                                                govIdForm.data.philhealth_number
                                            }
                                            onChange={(e) =>
                                                govIdForm.setData(
                                                    'philhealth_number',
                            ...
                            <CardContent className="space-y-6">
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select
                                            value={
                                                emergencyForm.data.relationship
                                            }
                                            onValueChange={(value) =>
                                                emergencyForm.setData(
                                                    'relationship',
                        ...
                        <div className="animate-fade-in space-y-6">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Upload your requirements (Resume, IDs,
                                        NBI & PNP Clearance, Medical Cert)
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <form
                    ...
                    <Alert className="border-blue-200 bg-blue-50">
                        <Info className="h-4 w-4 text-blue-600" />
                        <AlertDescription className="text-blue-800">
                            <strong>Auto-saved.</strong> Valid until{' '}
