...
export default function Apply({
    ...
    const selectedBalance = data.leave_type_id
        ? activeBalances[data.leave_type_id]
        : null;
        ...
        >
            ...
            <div className="space-y-6">
                ...
                {isHROrAdmin && allUsers && allUsers.length > 0 && (
                    <Card className="animate-fade-in border-2 border-purple-200 bg-purple-50">
                        <CardHeader>
                            ...
                            <CardDescription className="text-purple-700">
                                As HR/Admin, you can submit leave requests on
                                behalf of employees
                            </CardDescription>
                        </CardHeader>
                                    ...
                                    <div className="flex items-center space-x-3 rounded-lg bg-gray-50 p-4">
                                        ...
                                        >
                                            ...
                                            {filingForOther
                                                ? "employee's"
                                                : 'my'}{' '}
                                            default emergency contact from
                                            profile
                                            {(filingForOther
                                                ? selectedEmployee
                                                : user
